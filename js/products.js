...
let main = document.getElementById(`cardsProducts`)
...
function printProducts () {
    let cards = document.getElementById(`cardsProducts`)
    Products.forEach (e => {
...
kim_black_crocco.limitedEdition(2)
...
// I M P R I M O   P R O D U C T O S //
printProducts()
// G U A R D O   P R O D U C T O S   E N   E L   L O C A L    S T O R A G E //
saveLocal()