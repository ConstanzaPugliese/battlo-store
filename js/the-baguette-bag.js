...
let main = document.getElementById(`cardsBaguette`)
let title = document.createElement(`h1`)
title.setAttribute(`class`, `col-lg-12 col-xs-12 my-4`)
title.textContent = `The Baguette Bag`
main.prepend(title)
// P R O D U C T O S //
const fromJson = localStorage.getItem(`products`)
const Products = JSON.parse(fromJson)
let ProductsCategory = []
let currentCategory = `The Baguette Bag`
// C A R R I T O //
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textBaguette`);
const DOMshoppingCart = document.getElementById(`shoppingCartBaguette`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyBaguette`);
const DOMtotal = document.getElementById(`totalBaguette`);
const DOMinstallmentValue = document.getElementById(`installmentValueBaguette`);
const DOMbuttonBuy = document.getElementById(`buttonBuyBaguette`);
...
function printProducts() {
    filterCategory()
    let cards = document.getElementById(`cardsBaguette`)
...
function block () {
    const div1 = document.getElementById(`noneBlockBaguette`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockBaguette`)
