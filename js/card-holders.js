...
let main = document.getElementById(`cardsCardHolders`)
let title = document.createElement(`h1`)
title.setAttribute(`class`, `col-lg-12 col-xs-12 my-4`)
title.textContent = `Tarjeteros`
main.prepend(title)
// P R O D U C T O S //
const fromJson = localStorage.getItem(`products`)
const Products = JSON.parse(fromJson)
let ProductsCategory = []
let currentCategory = `card-holders`
// C A R R I T O //
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textCardHolders`);
const DOMshoppingCart = document.getElementById(`shoppingCartCardHolders`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyCardHolders`);
const DOMtotal = document.getElementById(`totalCardHolders`);
const DOMinstallmentValue = document.getElementById(`installmentValueCardHolders`);
const DOMbuttonBuy = document.getElementById(`buttonBuyCardHolders`);
...
function printProducts() {
    filterCategory()
    let cards = document.getElementById(`cardsCardHolders`)
...
function block () {
    const div1 = document.getElementById(`noneBlockCardHolders`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockCardHolders`)
