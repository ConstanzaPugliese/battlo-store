...
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textPolicies`);
const DOMshoppingCart = document.getElementById(`shoppingCartPolicies`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyPolicies`);
const DOMtotal = document.getElementById(`totalPolicies`);
const DOMinstallmentValue = document.getElementById(`installmentValuePolicies`);
const DOMbuttonBuy = document.getElementById(`buttonBuyPolicies`);
...
function block () {
    const div1 = document.getElementById(`noneBlockPolicies`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockPolicies`)
