...
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textKim`);
const DOMshoppingCart = document.getElementById(`shoppingCartKim`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyKim`);
const DOMtotal = document.getElementById(`totalKim`);
const DOMinstallmentValue = document.getElementById(`installmentValueKim`);
const DOMbuttonBuy = document.getElementById(`buttonBuyKim`);
...
function block () {
    const div1 = document.getElementById(`noneBlockKim`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockKim`)
