...
let main = document.getElementById(`cardsBritney`)
let title = document.createElement(`h1`)
title.setAttribute(`class`, `col-lg-12 col-xs-12 my-4`)
title.textContent = `Britney Crossbody`
main.prepend(title)
// P R O D U C T O S //
const fromJson = localStorage.getItem(`products`)
const Products = JSON.parse(fromJson)
let ProductsCategory = []
let currentCategory = `Britney`
// C A R R I T O //
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textBritney`);
const DOMshoppingCart = document.getElementById(`shoppingCartBritney`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyBritney`);
const DOMtotal = document.getElementById(`totalBritney`);
const DOMinstallmentValue = document.getElementById(`installmentValueBritney`);
const DOMbuttonBuy = document.getElementById(`buttonBuyBritney`);
...
function printProducts() {
    filterCategory()
    let cards = document.getElementById(`cardsBritney`)
...
function block () {
    const div1 = document.getElementById(`noneBlockBritney`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockBritney`)
