...
let main = document.getElementById(`cardsHannah`)
let title = document.createElement(`h1`)
title.setAttribute(`class`, `col-lg-12 col-xs-12 my-4`)
title.textContent = `Hannah Minibag`
main.prepend(title)
// P R O D U C T O S //
const fromJson = localStorage.getItem(`products`)
const Products = JSON.parse(fromJson)
let ProductsCategory = []
let currentCategory = `Hannah`
// C A R R I T O //
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textHannah`);
const DOMshoppingCart = document.getElementById(`shoppingCartHannah`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyHannah`);
const DOMtotal = document.getElementById(`totalHannah`);
const DOMinstallmentValue = document.getElementById(`installmentValueHannah`);
const DOMbuttonBuy = document.getElementById(`buttonBuyHannah`);
...
function printProducts() {
    filterCategory()
    let cards = document.getElementById(`cardsHannah`)
...
function block () {
    const div1 = document.getElementById(`noneBlockHannah`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockHannah`)
