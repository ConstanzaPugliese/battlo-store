...
let main = document.getElementById(`cardsHailey`)
let title = document.createElement(`h1`)
title.setAttribute(`class`, `col-lg-12 col-xs-12 my-4`)
title.textContent = `Hailey Minibag`
main.prepend(title)
// P R O D U C T O S //
const fromJson = localStorage.getItem(`products`)
const Products = JSON.parse(fromJson)
let ProductsCategory = []
let currentCategory = `Hailey`
// C A R R I T O //
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textHailey`);
const DOMshoppingCart = document.getElementById(`shoppingCartHailey`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyHailey`);
const DOMtotal = document.getElementById(`totalHailey`);
const DOMinstallmentValue = document.getElementById(`installmentValueHailey`);
const DOMbuttonBuy = document.getElementById(`buttonBuyHailey`);
...
function printProducts() {
    filterCategory()
    let cards = document.getElementById(`cardsHailey`)
...
function block () {
    const div1 = document.getElementById(`noneBlockHailey`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockHailey`)
