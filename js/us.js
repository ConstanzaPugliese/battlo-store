...
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textUs`);
const DOMshoppingCart = document.getElementById(`shoppingCartUs`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyUs`);
const DOMtotal = document.getElementById(`totalUs`);
const DOMinstallmentValue = document.getElementById(`installmentValueUs`);
const DOMbuttonBuy = document.getElementById(`buttonBuyUs`);
...
function block () {
    const div1 = document.getElementById(`noneBlockUs`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockUs`)
