...
let shoppingCart = [];
let total = 0;
const DOMtext = document.getElementById(`textBelts`);
const DOMshoppingCart = document.getElementById(`shoppingCartBelts`);
const DOMbuttonEmpty = document.getElementById(`buttonEmptyBelts`);
const DOMtotal = document.getElementById(`totalBelts`);
const DOMinstallmentValue = document.getElementById(`installmentValueBelts`);
const DOMbuttonBuy = document.getElementById(`buttonBuyBelts`);
...
function block () {
    const div1 = document.getElementById(`noneBlockBelts`)
    div1.style.display = `block`;
}
function none () {
    const div2 = document.getElementById(`noneBlockBelts`)
